export const linkedinBlogs = [
    {
        title: "Introducing MCP Servers - UiPath's New Capability for Agents",
        description:
    ...
    {
        title: "Transforming Document Processing",
        description:
    ...
    {
        title: "Devin AI: Revolutionizing Software Engineering with Autonomous Intelligence",
        description:
    ...
    {
        title: "A Guide to Creating Custom Activities",
        description:
